...
<div>
    <div className={styles.contentwrapper}>
        ...
        <p className={styles.nameStyle}>I write technical blogs in <Link href="https://yudhajitadhikary.medium.com/"><a target="_blank" className={styles.anchor} rel="noreferrer">Medium.com</a></Link> . Through my blogs i try to bring technical knowledge that I have learned & worked on over the few years to my reader in my own simple way.The way I used to understand things with a simple demo with a complete line by line code walk through.</p>
        ...
        <div className={styles.cardParent}>
            ...
            <div key={index} className='parentCardWrapper'>
                <div>
                    <div>
                        <Link href={item.url}><a className={styles.anchorLink}  target="_blank" rel="noreferrer">
