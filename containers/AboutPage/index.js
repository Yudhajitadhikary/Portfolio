...
<div className={styles.body}>
    <div className={styles.contentwrapper}>
        ...
        <p className={styles.nameStyle}>Want to know more on my&nbsp;<Link href="/Resume.pdf" ><a target={'_blank'} className={styles.anchor} rel="noreferrer">Technical Skill ?</a></Link></p>
