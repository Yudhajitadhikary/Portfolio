...
<div>
    <div className={styles.contentwrapper}>
        ...
        <p className={styles.nameStyle}>I write technical blogs in <a target="_blank" className={styles.anchor} href="https://yudhajitadhikary.medium.com/">Medium.com</a> . Through my blogs i try to bring technical knowledge that I have learned & worked on over the few years to my reader in my own simple way.The way I used to understand things with a simple demo with a complete line by line code walk through.</p>
